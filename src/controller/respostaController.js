...
import {criarRespostaService, consultarRespostasService, consultarRespostaPorIdService, deletarRespostaService, atualizarRespostaService } from "../service/respostaService.js";

const endpoint = Router()

endpoint.post("/resposta", async (req, resp) => {
    try {
        const resposta = await req.body;

        const idMensagem = await criarMensagemService(resposta)
